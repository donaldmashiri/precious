<nav x-data="{ open: false }" class="bg-white border-b shadow-sm" style="border-color: #800020;">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <div>
                            <h1 class="text-xl font-bold leading-tight" style="color: #800020;">ITAS</h1>
                            <p class="text-xs text-gray-600 leading-tight">Healthcare System</p>
                        </div>
                    </a>
                </div>
